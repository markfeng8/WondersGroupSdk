...
public class PayMethodListItem extends BaseAdapter {
    ...
    /**
     * Get a IView that displays the data at the specified position in the data set. You can either
     * create a IView manually or inflate it from an XML layout file. When the IView is inflated, the
     * parent IView (GridView, ListView...) will apply default layout parameters unless you use
     ...
     *                    Heterogeneous lists can specify their number of view types, so that this IView is
     *                    always of the right type (see {@link #getViewTypeCount()} and
     *                    {@link #getItemViewType(int)}).
     * @param parent      The parent that this view will eventually be attached to
     * @return A IView corresponding to the data at the specified position.
     */
    @Override
